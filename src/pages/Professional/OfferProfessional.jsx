...
const Offer = () => {
    ...
    const t = {
        ...
        infoTitle:
            language === "pl" ? "Strony Informacyjne" : "Informational Websites",
        infoText:
            language === "pl"
        ...
        backendTitle:
            language === "pl" ? "Proste Funkcje Zaplecza" : "Light Backend Features",
        backendText:
            language === "pl"
            ...
            >
                ...
                >
                    ...
                    >
                                        ...
                                        <Card
                                            ...
                                            style={{
                                                background:
                                                    ...
                                                    (isNight ? "rgba(255,255,255,0.03)" : "#f9f9f9"),
                        ...
                        >
                            <strong>{language === "pl" ? "Cennik:" : "Pricing:"}</strong>{" "}
                            {t.pricing}
                        </motion.p>
                    </motion.div>
                </Container>
